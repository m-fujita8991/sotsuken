...
<body>
	...
	<div id="container">
		...
		<header>
			<div class="inner">
				<h1 id="logo"><a href="index.html"><img src="images/logo.png" alt="素泊まり.com"></a></h1>
			</div>
			...
			<div class="inner">
				...
				<div class="main">
					...
					<section>
						...
						<div class="list">
							<a href="hotel/sample.html">
								<figure><img src="images/birejji.jfif" alt="写真の説明"></figure>
								<h4>ビレッジハウス山崎</h4>
								<table>
									<tr>
										<th>所在地</th>
						...
						<div class="list">
							<a href="hotel/sample.html">
								...
								<table>
									<tr>
										<th>所在地</th>
										<td>岡山県岡山市北区津倉町2丁目10-22</td>
										<th>価格</th>
										<td>無料</td>
									</tr>
									<tr>
										<th>生活環境</th>
										<td>人が住める環境ではありません</td>
										<th>住民</th>
										<td>三階に天然パーマの性欲魔神がいつも徘徊しているらしい...</td>
									</tr>
								</table>
